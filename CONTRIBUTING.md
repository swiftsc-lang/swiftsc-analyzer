# Contributing to SwiftSC (swiftsc-analyzer)
...
## Security Analysis
*   **New Rules**: Add detection logic in `src/security.rs`.
*   **False Positives**: Ensure your rule does not flag valid code patterns.
*   **Verification**: Add regression tests for every new vulnerability pattern detected.
